...
#' 
#' @source 
#' See \url{https://cran.r-project.org/web/packages/stm/index.html} for more details.
#'
#' @docType data
#' @name modtest
#' @usage data(modtest)
...
#' \item{\code{work_id}}{Mturk worker id. If 0, then the task hasn't been completed.}
